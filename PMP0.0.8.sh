...
WIDTH=50
CHOICE_HEIGHT=10
BACKTITLE="PMP v.0.0.8 by Kali_Yuga"
TITLE="PMP - Personal-Maintain-Program v.0.0.8"
...
clear
	case $CHOICE in
	  ...
	  WIDTH=40
	  CHOICE_HEIGHT=9
	  BACKTITLE="PMP v.0.0.8 by Kali_Yuga / Computer Maintenance"
	...
	case $CHOICE in
	    ...
	    printf "==========================================\n";
            ...
            2)
             dialog \
	    --title "Auto-Remove" \
	    --backtitle "PMP v.0.0.8 by Kali_Yuga / Auto-Remove" \
	    ...
	    printf "==========================================\n";
	      ...
	      WIDTH=52
	      CHOICE_HEIGHT=6
	      BACKTITLE="PMP v.0.0.8 by Kali_Yuga / Computer Maintenance / Kernel Remover"
		  ...
		  dialog --clear \
		  --backtitle "PMP v.0.0.8 by Kali_Yuga / Computer Maintenance / All Kernel Images & Configuration files" \
		  --title "$TITLE" \
		  --textbox /tmp/space.txt 25 80
		  clear;
		  ;;
		  ...
		  clear
		  dialog --clear \
		  --backtitle "PMP v.0.0.8 by Kali_Yuga / Computer Maintenance / Removable Kernel Images & Configuration Files" \
		  --title "$TITLE" \
		  --textbox /tmp/space.txt 25 80
		  clear;
		  ;;
		  ...
		  dialog --clear \
		  --title "$TITLE Info" \
		  --backtitle "PMP v.0.0.8 by Kali_Yuga / Computer Maintenance / Understanding Package States" \
		  ...
		  dialog --clear \
		  --title "$TITLE Help" \
		  --backtitle "PMP v.0.0.8 by Kali_Yuga / Computer Maintenance / Help" \
		  ...
		  ;;
            6)
            TITLE="PMP v0.0.8 - Install Software"
	    PROGRAM=$(dialog \
	    --title "$TITLE" \
	    ...
	    ;;
	    7)
	    TITLE="PMP v0.0.8 - Remove Software"
	    PROGRAM=$(dialog \
	    --title "$TITLE" \
	    ...
	    ;;
	    8)
	    BACKTITLE="PMP v.0.0.8 / Search Repository and Install Software"
...
3) Kill by Name            6) Exit"
	...
	3)
	    dialog \
	    --title "Wine Killer" \
	    --backtitle "PMP v.0.0.8 by Kali_Yuga / Kill Wine" \
...
do
  ...
  case "$key" in
	...
	9)
	    TITLE="About"
	    BACKTITLE="PMP v.0.0.8  by Kali_Yuga / About"
	    dialog \
	    --title "$TITLE" \
	    --backtitle "$BACKTITLE" \
