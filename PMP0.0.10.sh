...
WIDTH=50
CHOICE_HEIGHT=10
BACKTITLE="PMP v.0.0.10 by Kali_Yuga"
TITLE="PMP - Personal-Maintain-Program v.0.0.10"
...
case $CHOICE in
	  ...
	  WIDTH=40
	  CHOICE_HEIGHT=10
	  BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Computer Maintenance"
	  ...
	  CHOICE=$(dialog --clear \
	    ...
	    case $CHOICE in ##Choice in Maintenance Menu
		  ...
		  dialog \
		  --title "Auto-Remove" \
		  --backtitle "PMP v.0.0.10 by Kali_Yuga / Computer Maintenance / Auto-Remove" \
		  ...
		  WIDTH=45
		  CHOICE_HEIGHT=5
		  BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Computer Maintenance / Kernel Remover"
		  ...
		  ;;
		  7) ##Remove Software
		  TITLE="PMP v0.0.10 - Remove Software"
		  PROGRAM=$(dialog \
		  --title "$TITLE" \
		  ...
		  do
		    ...
		    WIDTH=35
		    CHOICE_HEIGHT=2
		    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Computer Maintenance / Search & Install Software"
		  ...
		  while [[ 1 ]]
		  do
		  BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Computer Maintenance / Nvidia Driver Manager"
		  HEIGHT=14
		  WIDTH=40
		  CHOICE_HEIGHT=5
		  TITLE="$TITLE"
		  ...
		  while [[ 1 ]]
			  ...
			  1) ##Get Support
			    ...
			    do
			      ...
			      CHOICE=$(dialog --clear \
			      --backtitle "PMP v.0.0.10 by Kali_Yuga / Computer Maintenance / Find Linux Support" \
			      --title "$TITLE" \
			      --menu "$MENU" \
			      $HEIGHT $WIDTH $CHOICE_HEIGHT \
			      "${OPTIONS[@]}" \
				  ...
				  case $CHOICE in
					  ...
					  if [ "$?" -eq 0 ]; then ##Okay Nickname
						PW=$(dialog \
						      ...
						      --backtitle "$BACKTITLE / Connect to freenode" \
						      --stdout \
						      --inputbox "freenode.net password:" 7 40)
					  ...
					  --title "$TITLE" \
					  --backtitle "$BACKTITLE" \
					  --yesno "This Option opens an external link in Firefox!\n'https://freenode.net/kb/answer/registration'\nContinue?" 9 50
				      if [ "$?" -eq 0 ]; then ##YES how to register
					    firefox https://freenode.net/kb/answer/registration
				      elif [ "$?" -eq 1 ]; then ##NO how to register
					clear
				      fi
				      ;;
				      3)
	...
	do
	    ...
	    WIDTH=40
	    CHOICE_HEIGHT=9
	    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / System Monitor"
...
3) Kill by Name            6) Exit"
		  ...
		  ("Exit")
		    ...
		    do
		      ...
		      OPTIONS=(1 "Install acpi"
			    ...
			    3 "Show more Info")
		      CHOICE=$(dialog --clear \
		      --backtitle "PMP v.0.0.10 by Kali_Yuga / System Monitor / Battery & Power Info" \
		      --title "$TITLE" \
		      --menu "$MENU" \
		      $HEIGHT $WIDTH $CHOICE_HEIGHT \
		      "${OPTIONS[@]}" \
			...
			case $CHOICE in
				  ...
				  dialog --clear \
				      --title "$TITLE" \
				      --backtitle "PMP v.0.0.10 by Kali_Yuga / System Monitor / Battery & Power Info / Install acpi" \
				 ...
				 break
			      ...
			      acpi > '/tmp/space.txt'
				  dialog --clear \
				      --backtitle "PMP v.0.0.10 by Kali_Yuga / System Monitor / Battery & Power Info / Power Status" \
				      --title "$TITLE" \
				  ...
				  dialog --clear \
				      --backtitle "PMP v.0.0.10 by Kali_Yuga / System Monitor / Battery & Power Info / More Battery Information" \
				      --title "$TITLE" \
		    ...
		    WIDTH=40
		    CHOICE_HEIGHT=3
		    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / System Monitor / CPU Info"
		    TITLE="$TITLE"
		    MENU="Select one:"
		    ...
		    WIDTH=38
		    CHOICE_HEIGHT=3
		    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / System Monitor / Network Information"
		    TITLE="$TITLE"
		    MENU="Select one:"
	...
	3)
	    dialog \
		--title "Wine Killer" \
		--backtitle "PMP v.0.0.10 by Kali_Yuga / Kill Wine" \
	...
	do
	    ...
	    WIDTH=55
	    CHOICE_HEIGHT=10
	    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi"
		...
		1) ##Quick WiFi Installer
		  TITLE="PMP Wifi v.0.0.4"
		  BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Quick WiFi Installer"
		    dialog \
		    --title "$TITLE" \
		    --backtitle "$BACKTITLE" \
		...
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Installing Driver Utilities"
		    dialog \
		    --title "$TITLE" \
		    --backtitle "$BACKTITLE" \
		...
		3) ##Install WiFi Driver
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Install WiFi Driver"
		    dialog \
		    --title "$TITLE" \
		    --backtitle "$BACKTITLE" \
		...
		x=$(ls -rl /etc/ndiswrapper/*/* > /tmp/space.txt)
		    ...
		    --backtitle "PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Driver Configuration" \
		    --textbox /tmp/space.txt 20 100
		;;
		5) ##Set Ndiswrapper to Startup
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Set Ndiswrapper to Startup"
		    dialog \
		    --title "$TITLE" \
		    --backtitle "$BACKTITLE" \
		...
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Load Ndiswrapper Module"
		    dialog \
		    --title "$TITLE" \
		    --backtitle "$BACKTITLE" \
		...
		7) ##Remove WiFi driver
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Remove WiFi driver"
		   clear
		...
		8) ##Remove Driver Utilities
		TITLE="PMP Wifi v.0.0.4"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / Remove Driver Utilities"
			dialog \
			--title "$TITLE" \
			--backtitle "$BACKTITLE" \
		...
		TITLE="About"
		BACKTITLE="PMP v.0.0.10 by Kali_Yuga / PMP Wifi / About"
		      dialog \
		      --title "$TITLE" \
		      --backtitle "$BACKTITLE" \
		      --textbox /tmp/space.txt 25 80
	...
	;;
	6) ##Select Nvidia-Prime. Only for Nvidia Optimus
	      while [[ 1 ]]
	      do
	      HEIGHT=13
	      WIDTH=29
	...
	7)
	      ...
	      WIDTH=29
	      CHOICE_HEIGHT=6
	      BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Extras"
	      TITLE="Extras 0.0.2"
	      MENU="Select one:"
		  ...
		  case $CHOICE in ##start menu extras
			...
			md5sum $FILE > '/tmp/space.txt'
		      ...
		      WIDTH=29
		      CHOICE_HEIGHT=2
		      BACKTITLE="$BACKTITLE / DVD to .ISO 0.0.2"
		      TITLE="DvD to .ISO 0.0.2"
		      MENU="Select one:"
		      ...
		      "${OPTIONS[@]}" \
		      2>&1 >/dev/tty)
		      if [ "$?" -eq 0 ]; then ##Okay DVD2Iso Menu
			  case $CHOICE in
			  1) ##DVD2ISO
				dialog --clear \
			      --title "$TITLE" \
			  ...
			  2)
			    dialog --clear \
				  ...
				  --msgbox "Choose a destination for your ISO File &\ngive your ISO a Filename.\n\nTo save your ISO file,\nput a CD/DVD in your CD/DVD tray and choose 'DvD to .ISO'\nto make an .iso ''Virtual Disc'' from your DVD's.\n\n*sadly won't work with copyright protected DVD's" 15 45
			    clear 
			  ;;
			  esac
		      elif [ "$?" -eq 1 ]; then ##Cancel DVD2Iso Menu
		      break
		      fi
		      done
		      ;;
...
do
  ...
  case "$key" in
	...
	BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Extras / PMPlayer 0.0.1"
	...
	CHOICE=$(dialog --clear \
			...
			if [ "$?" -eq 0 ]; then
			    ...
			    WIDTH=30
			    CHOICE_HEIGHT=6
			    BACKTITLE="PMP v.0.0.10 by Kali_Yuga / Extras / PMPlayer 0.0.1 / Library"
			    TITLE="Library"
			    MENU="Please choose one of the following Options:"
	...
	9)
	TITLE="About"
	BACKTITLE="PMP v.0.0.10  by Kali_Yuga / About"
	dialog --clear \
	       --title "$TITLE" \
	       --backtitle "$BACKTITLE" \
